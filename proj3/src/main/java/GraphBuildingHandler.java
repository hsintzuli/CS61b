...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private GraphDB.Way possibleWay;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            activeState = "way";
            possibleWay = new GraphDB.Way();
        } else if (activeState.equals("way") && qName.equals("nd")) {
            /* While looking at a way, we found a <nd...> tag. */
            possibleWay.extendNode(Long.parseLong(attributes.getValue("ref")));
...
//            System.out.println("Tag with k=" + k + ", v=" + v + ".");
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            ...
            if (possibleWay.validWay) {
                Long prevN = possibleWay.nodesInTheWay.remove();
                g.addWay(prevN, possibleWay.name);
                while (!possibleWay.nodesInTheWay.isEmpty()) {
                    Long lastN = possibleWay.nodesInTheWay.remove();
                    g.addWay(lastN, possibleWay.name);
                    g.addEdge(prevN, lastN);
                    prevN = lastN;
                }
                possibleWay = null;
            }
